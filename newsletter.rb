...
def calculate_recipients
  ans = SUBSCRIBERS
  ans.map do |subscribers|
    UNSUBSCRIBED.map do |unsubscribed|
      ans.delete(unsubscribed)
    end
  end
  ans
end
...
def print_many_articles(articles)
  # Made it to here, couldnt get the output to look how its suppose to
  articles.map do |art|
